...
import { chatbubbleOutline, chatbubble, locationOutline } from 'ionicons/icons';
...
const PostDetailPage: React.FC = () => {
  ...
  const postImages = post?.images?.length
    ? post.images.map((img) => getProfileImageUrl(img.imageUrl))
        ...
        {isLoading && (
          <div className="get-post-skeleton">
            ...
            <div className="ion-padding">
              ...
              <IonSkeletonText
                animated
                style={{ width: '90%', height: '12px', marginTop: '6px' }}
              />
              <IonSkeletonText
                animated
                style={{ width: '80%', height: '12px', marginTop: '6px' }}
              />
            </div>
          </div>
        )}
                      ...
                      <IonCol size="auto" className="ion-no-padding">
                        <div className="get-post-author">
                          ...
                          <div className="get-post-author-info">
                            <IonText className="get-post-author-name">{post.User?.name}</IonText>
                      ...
                      <div className="get-post-content-section">
                        ...
                        {(post.country || post.region) && (
                          <IonChip className="get-post-location" color="medium" outline>
                            ...
                            <span>{[post.country, post.region].filter(Boolean).join(' - ')}</span>
                          </IonChip>
                        )}
