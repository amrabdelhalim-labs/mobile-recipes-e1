...
describe('ثوابت الروابط (URL Constants)', () => {
    ...
    describe('قواعد التنسيق', () => {
        const allStaticUrls = [
            REGISTER_URL, LOGIN_URL, PROFILE_URL,
            PROFILE_UPDATE_INFO_URL, PROFILE_UPDATE_IMAGE_URL,
            PROFILE_RESET_IMAGE_URL, PROFILE_DELETE_URL,
            GET_ALL_POSTS, GET_MY_POSTS, CREATE_POST,
            GET_MY_COMMENTS, GET_MY_LIKES,
        ];
