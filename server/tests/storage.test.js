...
{
  const url = 'https://res.cloudinary.com/mycloud/image/upload/v1234567890/mobile-recipes/dish.jpg';
...
{
  const absUrl = 'https://res.cloudinary.com/mycloud/image/upload/v1/mobile-recipes/dish.jpg';
